  ...
  def render(assigns) do
    ...
    <div class="space-y-10 pb-20">
      ...
      <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <!-- Coming Soon Notice -->
        <div class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-10 lg:p-16 text-white shadow-2xl shadow-indigo-500/20 relative overflow-hidden group">
          ...
          <div class="relative z-10 flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="text-center md:text-left flex-1">
              ...
              <p class="text-xl text-white/90 font-medium leading-relaxed max-w-2xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="card-glass h-full">
            <div class="flex items-center gap-4 mb-10">
              ...
              <h4 class="text-2xl font-black text-slate-900 tracking-tight">Planned Features</h4>
            </div>
            ...
            <div class="grid gap-6">
              <%= for {title, desc} <- [
                ...
                <div class="flex items-start gap-4 p-4 rounded-2xl bg-slate-50/50 border-2 border-slate-50 hover:bg-white hover:border-turquoise-100 transition-all group">
                  ...
                  <div>
                    <p class="text-slate-900 font-black tracking-tight group-hover:text-turquoise-700 transition-colors">{title}</p>
                    <p class="text-slate-500 font-medium text-sm leading-relaxed">{desc}</p>
                  </div>
                </div>
              <% end %>
            </div>
    ...
    <!-- Stripe Benefits -->
          <div class="card-glass h-full">
            <div class="flex items-center gap-4 mb-10">
              <div class="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center border border-purple-100 shadow-sm">
                <svg class="h-6 w-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h4 class="text-2xl font-black text-slate-900 tracking-tight">Why Stripe?</h4>
            </div>
