defmodule TymeslotWeb.Dashboard.WebhookSettingsComponent do
  @moduledoc """
  LiveComponent for managing webhooks in the dashboard.

  Allows users to create, edit, delete, and test webhooks that
  trigger on booking events (created, cancelled, rescheduled).
  """
  ...
  # Component functions (will be moved to separate files)
