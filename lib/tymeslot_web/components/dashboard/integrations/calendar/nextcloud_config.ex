defmodule TymeslotWeb.Components.Dashboard.Integrations.Calendar.NextcloudConfig do
  @moduledoc """
  Component for configuring Nextcloud calendar integration.
  """
  use TymeslotWeb.Components.Dashboard.Integrations.Calendar.ConfigBase,
    provider: :nextcloud,
    default_name: "Nextcloud Calendar"
    ...
    <div class="relative">
      ...
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center">
          ...
          <h3 class="text-lg font-semibold text-gray-800">Setup Nextcloud Calendar</h3>
        </div>
        <UIComponents.close_button target={@target} />
      </div>
      
    <!-- Instructions Section -->
      <.nextcloud_instructions />
      ...
      <%= if @show_calendar_selection do %>
        ...
        <form phx-submit="add_integration" phx-target={@target} class="space-y-6">
          <SharedForm.integration_name_field
            ...
            placeholder="My Nextcloud Calendar"
          />

          <input type="hidden" name="integration[provider]" value="nextcloud" />
  ...
  # Function component for Nextcloud instructions
  defp nextcloud_instructions(assigns) do
    ~H"""
    <div class="mb-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- Setup Steps Card -->
            ...
            <div>
              ...
              <ul class="text-sm text-neutral-600 space-y-1">
                <li class="flex items-start">
                  <span class="text-turquoise-500 mr-1">1.</span> Find your server URL
                </li>
                <li class="flex items-start">
                  <span class="text-turquoise-500 mr-1">2.</span> Get your username
                </li>
                <li class="flex items-start">
                  <span class="text-turquoise-500 mr-1">3.</span> Create app password in Settings
                </li>
                <li class="flex items-start">
                  <span class="text-turquoise-500 mr-1">4.</span> Connect & discover calendars
                </li>
              </ul>
            </div>
          </div>
            ...
            <div>
              ...
              <ul class="text-sm text-neutral-600 space-y-1">
                <li class="flex items-center">
                  <span class="text-purple-500 mr-1">✓</span> Auto-discovery of all calendars
                </li>
                <li class="flex items-center">
                  <span class="text-purple-500 mr-1">✓</span> Real-time sync
                </li>
                <li class="flex items-center">
                  <span class="text-purple-500 mr-1">✓</span> Conflict prevention
                </li>
                <li class="flex items-center">
                  <span class="text-purple-500 mr-1">✓</span> Secure app passwords
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-neutral-600">
              Enter your Nextcloud server URL (e.g., cloud.example.com) or a direct calendar URL. You can omit https:// - we'll add it automatically. If using a calendar URL, we'll extract the username for you.
              <a
                href="https://docs.nextcloud.com/server/latest/user_manual/en/session_management.html#app-passwords"
                target="_blank"
