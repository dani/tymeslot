defmodule TymeslotWeb.Themes.Shared.EventHandlers do
  ...
  """
  @spec handle_toggle_language_dropdown(Phoenix.LiveView.Socket.t()) ::
  ...
  """
  @spec handle_close_language_dropdown(Phoenix.LiveView.Socket.t()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
  ...
  """
  @spec handle_timezone_change(Phoenix.LiveView.Socket.t(), map(), module()) ::
          {:noreply, Phoenix.LiveView.Socket.t()}
