defmodule Tymeslot.Integrations.Calendar.CalendarBehaviour do
  ...
  @callback create_event(map(), pos_integer() | nil) :: {:ok, any()} | {:error, any()}
  @callback update_event(binary(), map(), pos_integer() | nil) :: {:ok, any()} | {:error, any()}
  @callback delete_event(binary(), pos_integer() | nil) :: {:ok, any()} | {:error, any()}
  @callback get_booking_integration_info(pos_integer()) :: {:ok, map()} | {:error, any()}
end
